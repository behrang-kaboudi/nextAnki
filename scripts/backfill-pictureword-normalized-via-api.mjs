/**
 * Backfills PictureWord.ipa_fa_normalized by calling:
 * POST /api/ipa-test/backfill-pictureword-normalized
 *
 * Requirements:
...
async function main() {
  ...
  for (;;) {
    const url = new URL("/api/ipa-test/backfill-pictureword-normalized", baseUrl);
