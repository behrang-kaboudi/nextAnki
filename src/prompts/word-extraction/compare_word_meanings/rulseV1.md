...
7. آیا این کلمات انگلیسی قابلیت جایگزینی با هم رو دارند
   ...
   جوری باشه که واقعا تمایز این کلمه با کلمات دیگه رو نشون بده نیاز نیست به شدت قوی باشه که تمایز های خیلی ظریف رو نشون بده ولی توضیح خوبی از کلمه باشه که به موارد مورد بررسی هم اشاره کرده باش. بالای ۳۰ کلمه نره.
...
[{"persianWordId":123,"records":[{"id":10,"concept_explained_fa":"توضیح فارسی حداکثر ۳۰ کلمه","synonymIds":[11]},{"id":11,"concept_explained_fa":"توضیح فارسی حداکثر ۳۰ کلمه","synonymIds":[10]}]}]
