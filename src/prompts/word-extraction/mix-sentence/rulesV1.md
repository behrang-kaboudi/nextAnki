...
"meaning_fa" as the natural realized form of example_meaning_fa.
...
──────────────────────────────
1. Detect the Persian segment in example_meaning_fa that expresses meaning_fa. Understand that grammatical accuracy. Remove any extra words that are not part of meaning_fa.
...
3. Do NOT use the infinitive.
   Use only the realized surface form from example_meaning_fa.
...
and the Persian chunk extracted from example_meaning_fa is a verb phrase
...
Example:
example_meaning_fa: "او در سن کم کچل شد."
...
Example:
example_meaning_fa: "میزش همیشه مرتب است."
...
──────────────────────────────
If the extracted Persian chunk does NOT end with a punctuation mark inside example_meaning_fa,
