...
export const siteMapGroups: SiteMapGroup[] = [
  ...
  },
  {
    ...
    pages: [
      ...
      { title: "Sentence Table", path: "/words/tables/sentences", summary: "Browses unique Sentence records, linked words, and sentence-level metadata with direct editing.", menu: true },
