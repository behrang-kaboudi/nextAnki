...
type Report = { checked: number; foundUsPronunciation: number; updatedPhonetic: number; downloadedAudio: number; notFound: number; noUsPronunciation: number; rateLimited: number; failed: number; details: Array<{ id: number; normalized_text: string; outcome: string; detail: string }> };
